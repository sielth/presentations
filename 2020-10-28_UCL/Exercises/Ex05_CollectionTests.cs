...
namespace Exercises
{
    public class Ex05_CollectionTests
    {
        ...
        [Fact]
        public void GetObjects_HaveExactlyTwoItems()
        {
            // Arrange
            int expectedCount = 2;
        ...
        [Fact]
        public void GetObjects_ContainExactlyOneIntegerWithValue42()
        {
            // Arrange
            int expected = 42;
        ...
        [Fact]
        public void GetObjects_LastItemShouldBe42()
        {
            // Arrange
            int expected = 42;
        ...
        private static Person[] GetPersons() =>
            new Person[] { new Person { Name = "John", Company = "Refsvindinge Bryggeri" } };
